...
- `PLANNING.md` now explicitly covers Hermes-style scheduled automation semantics.
- The focused evaluator passed for the updated planning backlog.
- The source-grounded `[ ]` task list now matches Hermes's operator workflow more closely instead of leaving cron scheduler semantics implicit.
